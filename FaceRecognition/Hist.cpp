...
//
//
//void spatial_histogram(const Mat& src, Mat& hist, int numPatterns, const Size& window, int overlap) {
//	int width = src.cols;
//	int height = src.rows;
...
//}
//
//void spatial_histogram(const Mat& src, Mat& dst, int numPatterns, int gridx, int gridy, int overlap) {
...
//
//
//Mat spatial_histogram(const Mat& src, int numPatterns, const Size& window, int overlap) {
//	Mat hist;
...
//
//
//Mat spatial_histogram(const Mat& src, int numPatterns, int gridx, int gridy, int overlap) {
//	Mat hist;
